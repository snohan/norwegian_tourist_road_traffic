...
Alle data er hentet fra [www.vegvesen.no/trafikkdata/](https://www.vegvesen.no/trafikkdata/), og sist oppdatert `r today_string`. Nærmeste planlagte oppdateringer: juli/august 2023. Kontakt gjerne 'trafikkdata' snabela vegvesen punktum no ved spørsmål.
...
```{r plot_other, fig.height=10}
min_month_object_chosen <- min(summer_trp_mdt_long$month_object)
max_month_object_chosen <- max(summer_trp_mdt_long$month_object)
  ...
  summer_trp_mdt_long %>% 
    ...
    scale_x_date(
      ...
      labels = scales::label_date("%b"),
      limits = c(min_month_object_chosen, max_month_object_chosen)) +
    scale_fill_viridis_d(name = "År",
                         option = "cividis") +
    labs(x = NULL, y = "Månedsdøgntrafikk \n",
         caption = "Data: Statens vegvesen og fylkeskommunene") +
